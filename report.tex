...
\label{rtx}
RFC4585\cite{rfc4585} defines a RTCP Feedback message type called NACK, with
...
the video streams. Current versions do retransmission by send the exact same
...
special way-- we just ensure, for the purposes of recording, that we have
buffers of sufficient size (see section \ref{video-jb}).
