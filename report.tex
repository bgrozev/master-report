...
M-bit, beginnging of frame, all packets in a frame have same RTP TS
(and specifically \emph{libvpx}), there are two main entities: an encoder and a decoder. The encoder reads raw video frames (images in 

, an encoder produces "VP8 compressed frames" The transport of VP8 over RTP is being defined in the "payload-vp8" draft\cite{vp8rtp}. 
